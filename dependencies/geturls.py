...
class ScraperUrls():
    ...
    def AcceptCookies(self):
        try:
            OkBtn = self.driver.find_element("xpath","//a[@class='sc-bdVaJa ebNrSm sc-htoDjs brhAsq Button-bepvgg-0 dqiWxy text-center btn-disclaimer btn btn-secondary']")
            #webdriver.ActionChains(self.driver).move_to_element(NextPageButton).click(NextPageButton).perform()
            OkBtn.click()
        except:
            pass
